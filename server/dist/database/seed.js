...
async function seedDatabase() {
    try {
        ...
        const adminPasswordHash = await bcryptjs_1.default.hash('HenryDiag2024$', 12);
    ...
    `, [
        ...
        const mecanicoPasswordHash = await bcryptjs_1.default.hash('MecanicoHD2024!', 12);
        const ventasPasswordHash = await bcryptjs_1.default.hash('VentasHD2024!', 12);
        await (0, connection_1.query)(`
      INSERT INTO users (email, password_hash, nombre, rol, telefono, activo) 
      VALUES ($1, $2, $3, $4, $5, $6)
      ON CONFLICT (email) DO NOTHING
